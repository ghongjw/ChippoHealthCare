...
public class UMService {
	...
	public ArrayList<Integer> bookedPtDate(String year, String month) {
		...
		ArrayList<String> PtTimes = new ArrayList();
		for (int i = 0; i < PTDay.size(); i++) {
			String tmp = PTDay.get(i);
			PtTimes.add(umDao.getPttime(userId,tmp));
			String[] sp = tmp.split("-");
	...
	public ArrayList<String> getPtTimes() {
		return PtTimes;
	}
