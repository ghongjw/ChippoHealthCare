...
public class UMController implements Initializable {
	...
	@FXML
	private Label umNameLabel, umNameLabel2;
	@FXML
	private Label umLastday;
	@FXML
	private Label umPtLabel;
	@FXML
	private Label umYear;
	@FXML
	private Label umMonth;
	@FXML
	private Button umgoToUiButton;
	@FXML
	private Button umBackButton;
	@FXML
	private Button umLogoutButton;
	@FXML
	private Button umpreviousMonth;
	@FXML
	private Button umNextMonth;
	@FXML
	private Label sDay1, sDay2, sDay3, sDay4, sDay5, sDay6, sDay7, sDay8, sDay9, sDay10;
	@FXML
	private Label sDay11, sDay12, sDay13, sDay14, sDay15, sDay16, sDay17, sDay18, sDay19, sDay20;
	@FXML
	private Label sDay21, sDay22, sDay23, sDay24, sDay25, sDay26, sDay27, sDay28, sDay29, sDay30;
	@FXML
	private Label sDay31, sDay32, sDay33, sDay34, sDay35, sDay36, sDay37, sDay38, sDay39, sDay40, sDay41, sDay42;
	@FXML
	private Label ptReserve01, ptReserve02, ptReserve03, ptReserve04, ptReserve05, ptReserve06, ptReserve07,
			ptReserve08, ptReserve09, ptReserve10;
	@FXML
	private Label ptReserve11, ptReserve12, ptReserve13, ptReserve14, ptReserve15, ptReserve16, ptReserve17,
			ptReserve18, ptReserve19, ptReserve20;
	@FXML
	private Label ptReserve21, ptReserve22, ptReserve23, ptReserve24, ptReserve25, ptReserve26, ptReserve27,
			ptReserve28, ptReserve29, ptReserve30;
	@FXML
	private Label ptReserve31, ptReserve32, ptReserve33, ptReserve34, ptReserve35, ptReserve36, ptReserve37,
			ptReserve38, ptReserve39, ptReserve40, ptReserve41, ptReserve42;
	@FXML
	private Button umGoTOPerchase;
	@FXML
	private Button umGoTOBo;
	@FXML
	private Button umGoToRc;
	@FXML
	private Button umGoToInboby;
	@FXML
	private VBox dBox01, dBox02, dBox03, dBox04, dBox05, dBox06, dBox07, dBox08, dBox09, dBox10;
	@FXML
	private VBox dBox11, dBox12, dBox13, dBox14, dBox15, dBox16, dBox17, dBox18, dBox19, dBox20;
	@FXML
	private VBox dBox21, dBox22, dBox23, dBox24, dBox25, dBox26, dBox27, dBox28, dBox29, dBox30;
	@FXML
	private VBox dBox31, dBox32, dBox33, dBox34, dBox35, dBox36, dBox37, dBox38, dBox39, dBox40;
	@FXML
	private VBox dBox41, dBox42;
	@FXML
	private HBox hDayBox01, hDayBox02, hDayBox03, hDayBox04, hDayBox05, hDayBox06, hDayBox07, hDayBox08, hDayBox09,
			hDayBox10;
	private HBox hDayBox11, hDayBox12, hDayBox13, hDayBox14, hDayBox15, hDayBox16, hDayBox17, hDayBox18, hDayBox19,
			hDayBox20;
	private HBox hDayBox21, hDayBox22, hDayBox23, hDayBox24, hDayBox25, hDayBox26, hDayBox27, hDayBox28, hDayBox29,
			hDayBox30;
	private HBox hDayBox31, hDayBox32, hDayBox33, hDayBox34, hDayBox35, hDayBox36, hDayBox37, hDayBox38, hDayBox39,
			hDayBox40;
	private HBox hDayBox41, hDayBox42;
	...
	public void printCalendar(int year, int month, int dayMax, int dayWeek1) {
		...
		Label[] ptReserves = new Label[] { ptReserve01, ptReserve02, ptReserve03, ptReserve04, ptReserve05, ptReserve06,
				ptReserve07, ptReserve08, ptReserve09, ptReserve10, ptReserve11, ptReserve12, ptReserve13, ptReserve14,
				ptReserve15, ptReserve16, ptReserve17, ptReserve18, ptReserve19, ptReserve20, ptReserve21, ptReserve22,
				ptReserve23, ptReserve24, ptReserve25, ptReserve26, ptReserve27, ptReserve28, ptReserve29, ptReserve30,
				ptReserve31, ptReserve32, ptReserve33, ptReserve34, ptReserve35, ptReserve36, ptReserve37, ptReserve38,
				ptReserve39, ptReserve40, ptReserve41, ptReserve42 };
		sDays = new Label[] { sDay1, sDay2, sDay3, sDay4, sDay5, sDay6, sDay7, sDay8, sDay9, sDay10, sDay11, sDay12,
				sDay13, sDay14, sDay15, sDay16, sDay17, sDay18, sDay19, sDay20, sDay21, sDay22, sDay23, sDay24, sDay25,
				sDay26, sDay27, sDay28, sDay29, sDay30, sDay31, sDay32, sDay33, sDay34, sDay35, sDay36, sDay37, sDay38,
				sDay39, sDay40, sDay41, sDay42 };
		for (int i = 0; i < 42; i++) {
			sDays[i].setText(" ");
		...
		ArrayList<String> Pttime = umService.getPtTimes();
		String timeCheck = "";
		int indexBoPt;
		for (int i = 0; i < Ptmon.size(); i++) {
			if (Pttime.get(i).equals("T1")) {
				timeCheck = "7시 ";
			} else if (Pttime.get(i).equals("T2")) {
				timeCheck = "9시 ";
			} else if (Pttime.get(i).equals("T3")) {
				timeCheck = "11시 ";
			} else if (Pttime.get(i).equals("T4")) {
				timeCheck = "13시 ";
			} else if (Pttime.get(i).equals("T5")) {
				timeCheck = "15시 ";
			} else if (Pttime.get(i).equals("T6")) {
				timeCheck = "17시 ";
			} else if (Pttime.get(i).equals("T7")) {
				timeCheck = "19시 ";
			} else if (Pttime.get(i).equals("T8")) {
				timeCheck = "21시 ";
			} else if (Pttime.get(i).equals("T9")) {
				timeCheck = "23시 ";
			}
			indexBoPt = Ptmon.get(i) + dayWeek1;
			ptReserves[indexBoPt - 2].setText("PT : " + timeCheck);
	...
	public void todayselct(int a) {
		int tmp = day + a - 2;
		HBox[] hboxs = { hDayBox01, hDayBox02, hDayBox03, hDayBox04, hDayBox05, hDayBox06, hDayBox07, hDayBox08,
				hDayBox09, hDayBox10, hDayBox11, hDayBox12, hDayBox13, hDayBox14, hDayBox15, hDayBox16, hDayBox17,
				hDayBox18, hDayBox19, hDayBox20, hDayBox21, hDayBox22, hDayBox23, hDayBox24, hDayBox25, hDayBox26,
				hDayBox27, hDayBox28, hDayBox29, hDayBox30, hDayBox31, hDayBox32, hDayBox33, hDayBox34, hDayBox35,
				hDayBox36, hDayBox37, hDayBox38, hDayBox39, hDayBox40, hDayBox41, hDayBox42 };
		String tmpMonth = umMonth.getText();
		if (tmpMonth.length() == 1)
			tmpMonth = "0" + tmpMonth;
		hboxs[tmp].getChildren().add(todayLabel);
