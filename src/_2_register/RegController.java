...
public class RegController implements Initializable {
	...
	private String id, pw, name, address, email, mobile, gender, age;
	...
	public void certificationNumProc() {
		////////////////////////////////////////////////////////////// (인증번호 랜덤)
		System.out.println(regDTO.getconfirmNum() + "\t" + confirmNum.getText());
		if (Mobile.getText().equals(regDTO.getMobile()) && confirmNum.getText().equals(regDTO.getconfirmNum())) {
			CommonService.msg("본인 인증되었습니다.");
		} else
