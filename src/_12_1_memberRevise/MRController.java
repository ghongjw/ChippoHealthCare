...
public class MRController implements Initializable {
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		if (msDto.getPurposse().equals("diet  ")) {
			diet.setSelected(true);
		} else if (msDto.getPurposse().equals("diet  competition  ")) {
			diet.setSelected(true);
			com.setSelected(true);
		} else if (msDto.getPurposse().equals("diet  health")) {
			diet.setSelected(true);
			heal.setSelected(true);
		} else if (msDto.getPurposse().equals("competition")) {
			com.setSelected(true);
		} else if (msDto.getPurposse().equals("competition  health")) {
			com.setSelected(true);
			heal.setSelected(true);
		} else if (msDto.getPurposse().equals("health")) {
			heal.setSelected(true);
		} else if (msDto.getPurposse().equals("diet  competition  health")) {
			diet.setSelected(true);
			com.setSelected(true);
			heal.setSelected(true);
		}
